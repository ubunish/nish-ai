...
description: >
  ...
  redirects python/pip/poetry/pipenv/virtualenv to their uv equivalents. Rides
  the auto-active tier alongside nish-ai-writing-style and nish-ai-coding, and
  is backed by a PreToolUse hook that blocks bare calls and returns the uv
...
nish-ignition already installs uv and builds the `~/.venvs/*` environments with
